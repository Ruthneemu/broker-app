  ...
  const AdminDashboard = () => {
    ...
    return (
      <div className="bg-gray-50 min-h-screen p-4 md:p-8">
        <div className="bg-white rounded-2xl shadow-lg w-full max-w-7xl mx-auto my-4 md:my-8 overflow-hidden">
          <div className="bg-gradient-to-r from-blue-600 to-indigo-700 p-6 md:p-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <h2 className="text-2xl md:text-3xl font-bold text-white mb-4 md:mb-0">Admin Dashboard</h2>
              <button
                onClick={() => setShowAdminDashboard(false)}
                className="px-6 py-2 bg-white text-indigo-700 font-semibold rounded-full hover:bg-gray-100 transition-colors"
              >
                Back to Listings
              </button>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-6 rounded-xl border border-blue-100 shadow-sm">
                <div className="flex items-center">
                  ...
                  <div>
                    <h3 className="text-sm font-semibold text-blue-700 uppercase tracking-wider">Total Listings</h3>
                    <p className="mt-1 text-3xl font-bold text-blue-900">{dashboardStats.totalListings}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-6 rounded-xl border border-green-100 shadow-sm">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-3xl font-bold text-green-900">{dashboardStats.totalUsers}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-amber-50 to-orange-50 p-6 rounded-xl border border-amber-100 shadow-sm">
                <div className="flex items-center">
                  ...
                  <div>
                    <h3 className="text-sm font-semibold text-amber-700 uppercase tracking-wider">Total Views</h3>
                    <p className="mt-1 text-3xl font-bold text-amber-900">{dashboardStats.totalViews}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-8 md:space-y-12">
              <div>
                <h3 className="text-xl md:text-2xl font-bold mb-6 text-gray-800 flex items-center">
                  <i className="fas fa-list-alt text-indigo-600 mr-3"></i>
                  All Listings (Most Viewed)
                </h3>
                        ...
                        <tr key={listing.id} className="hover:bg-gray-50">
                          <td className="px-6 py-4 whitespace-nowrap">
                            {listing.image_urls && listing.image_urls.length > 0 && (
                              <img src={listing.image_urls[0]} alt="Listing" className="w-16 h-12 object-cover rounded-md" />
                            )}
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap">
        ...
        <header className="bg-white shadow-sm sticky top-0 z-40 border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <h1 className="text-2xl font-bold text-gray-900">
              <span className="text-blue-600">Broker</span><span className="text-gray-800">Find</span>
            </h1>
            {isLoggedIn ? (
              <button onClick={handleLogout} className="px-4 py-2 bg-red-500 text-white font-medium rounded-lg hover:bg-red-600 transition-colors">
                Logout
              </button>
            ) : (
              <button onClick={() => setShowLoginModal(true)} className="px-4 py-2 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-colors">
                Login
              </button>
            )}
          </div>
            ...
            <div className="p-6 md:p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="md:col-span-2">
                  ...
                  <p className="text-gray-600 mb-6">Interested in this listing? Fill out the form below and the broker will get in touch with you.</p>
                  ...
                  <div className="p-5">
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <div className="flex items-center space-x-1 text-sm">
                        ...
                        <span className="text-gray-500">({listing.reviews.length})</span>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      ...
                      {listing.type === 'car' && listing.details && (
                        <>
                          <div className="flex items-center text-sm text-gray-700 bg-gray-100 px-2 py-1 rounded">
                            <i className="fas fa-car text-blue-500 mr-1"></i>
                            <span>{listing.details.make}</span>
                          </div>
                          <div className="flex items-center text-sm text-gray-700 bg-gray-100 px-2 py-1 rounded">
                            <i className="fas fa-tachometer-alt text-blue-500 mr-1"></i>
                            <span>{listing.details.mileage} miles</span>
                          </div>
                        </>
                      )}
                      {listing.type === 'land' && listing.details && (
                        <>
                          <div className="flex items-center text-sm text-gray-700 bg-gray-100 px-2 py-1 rounded">
                            <i className="fas fa-tree text-blue-500 mr-1"></i>
                            <span>{listing.details.acres} Acres</span>
                          </div>
                          <div className="flex items-center text-sm text-gray-700 bg-gray-100 px-2 py-1 rounded">
                            <i className="fas fa-ruler text-blue-500 mr-1"></i>
                            <span>{listing.details.zoning}</span>
                          </div>
                        </>
                      )}
                    </div>
            ...
            <nav className="hidden md:flex items-center space-x-1">
              ...
              {isLoggedIn ? (
                <button 
                  ...
                  className="ml-2 px-4 py-2 rounded-lg font-medium bg-red-100 text-red-700 hover:bg-red-200 transition-colors"
                >
                  Logout
                </button>
              ) : (
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
          <div>
            ...
            <p className="text-gray-600">
              {currentView === 'public' && 'Browse through our extensive collection of properties'}
              {currentView === 'private' && 'Manage your property listings'}
              {currentView === 'favorites' && 'Your saved properties'}
            </p>
          </div>
          ...
          {isLoggedIn && currentView === 'private' && (
            <button
              ...
              className="mt-4 md:mt-0 px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg shadow hover:bg-blue-700 transition-colors flex items-center"
            >
        ...
        {currentView === 'public' && (
          <div className="bg-white rounded-2xl shadow-sm p-6 mb-8 border border-gray-200">
            ...
            {(selectedType === 'house' || selectedType === '') && (
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                <div>
                  <label className="block text-gray-700 font-medium mb-2">Min Beds</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-gray-700 font-medium mb-2">Min Baths</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-gray-700 font-medium mb-2">Min Sqft</label>
                  <input
                    type="number"
            ...
            {selectedType === 'car' && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                <div>
                  <label className="block text-gray-700 font-medium mb-2">Car Make</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-gray-700 font-medium mb-2">Max Mileage</label>
                  <input
                    type="number"
            ...
            {selectedType === 'land' && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                <div>
                  <label className="block text-gray-700 font-medium mb-2">Max Acres</label>
                  <input
                    type="number"
